...
include 'E:/anaconda3/envs/vanilla2/lib/site-packages/qutip/cy/complex_math.pxi'

cdef complex spectral0(double w, double t): return  2*pi* 2.0 * 0.2 / (pi * 0.1 * 1.0)  if (w==0) else 2*pi*(2.0*0.2*0.1 *w /(pi*(w**2+0.1**2))) * ((1/(exp((w) * 1.0)-1))+1)
